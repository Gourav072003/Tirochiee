    ...
    <div class="card-body">
      <form method="post" action="{{route('product.store')}}">
        ...
        <div class="form-group">
          ...
          <input id="thumbnail" class="form-control" type="text" name="photo" value="{{old('photo')}}" placeholder="Select one or more product images">
        </div>
        <small class="form-text text-muted">You can select multiple images. They will be saved as a comma-separated gallery and shown as thumbnails on the product page.</small>
